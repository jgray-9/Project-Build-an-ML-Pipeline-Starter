...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "File path of raw dataset to be cleaned",
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "File path to cleaned dataset",
        required = True
    )
    ...
    parser.add_argument(
        "--output_type", 
        type = str,
        help = "Type of output artifact (cleaned dataset)",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "Minimum house price in dataset",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "Maximum house price in dataset",
        required = True
    )
